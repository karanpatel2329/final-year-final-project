...
function DashboardMain({ handleToggleSidebar }) {
  ...
  const reportLink="teacher/dashboard/report";
  const attendanceLink="teacher/dashboard/attendance";
  return (
    <main className={style.main}>
      <Grid container className={style.mainContainer}>
        ...
        <Block image={view} targetLink={reportLink} text="View Student Report" className={style1.blockItem} ></Block>
        <Block image={attendance}  targetLink={attendanceLink} text="View Student Attendance" className={style1.blockItem}></Block>
        </div>
        <div className={style1.Blocks1}>
