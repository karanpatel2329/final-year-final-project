...
function AddSubjectMain({handleToggleSidebar}){
  ...
  axios.post('http://localhost:3000/getSubjectById',  {"_id":id} , axiosConfig)
    .then(res => {
      ...
      setMod1(res.data[0].module1);
      setMod2(res.data[0].module2);
      setMod3(res.data[0].module3);
      setMod4(res.data[0].module4);
      setMod5(res.data[0].module5);
      setOpen(true);
    }).catch(e=>console.log(e))
    setLoading(false);
  }
  ...
  if(typeof window === 'undefined'){
    ...
    return (
      ...
      <center><h1>Add Subject</h1></center>
          <Grid container>
                <Grid item>
                <TextField className={style.text1}  fullWidth label="Subject Name" id="subjectname"value={subject}  onChange={e=>setSubject(e.target.value)}/>
                </Grid>
          </Grid>
          ...
          <Grid container>
                <Grid item>
                <TextField className={style.text1}  fullWidth label="Subject Short Name" id="subjectnameshort" value={subjectShort} onChange={e=>setSubjectShort(e.target.value)}/>
                </Grid>
          </Grid>
          ...
          <Grid container>
                <Grid item>
                <TextField className={style.text1}  fullWidth label="Subject Code" id="subjectcode" value={subjectCode} onChange={e=>setSubjectCode(e.target.value)}/>
                </Grid>
          </Grid>
          ...
          <Button variant="contained" className={style.text1} onClick={()=>onSubmit()} >Submit</Button>
      </FormControl>  
        </div></Dialog>:<></> }
      </main>
    );
